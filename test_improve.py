...
class RedirectionTest(unittest.TestCase):
    ...
    def test_redirection(self):
        ...
        time.sleep(2)
        click_elem_200 = driver.find_element(By.XPATH, '//*[@id="content"]/div/ul/li[1]/a')
        self.assertTrue(click_elem_200)
        time.sleep(2)
        click_elem_200.click()
        time.sleep(2)
        driver.save_screenshot("200.png")
        back_elem = driver.find_element(By.XPATH, '//*[@id="content"]/div/p/a')
        self.assertTrue(back_elem)
        time.sleep(2)
        back_elem.click()
        time.sleep(2)

        click_elem_301 = driver.find_element(By.XPATH, '//*[@id="content"]/div/ul/li[2]/a')
        ...
        click_elem_404 = driver.find_element(By.XPATH, '//*[@id="content"]/div/ul/li[3]/a')
        ...
        click_elem_500 = driver.find_element(By.XPATH, '//*[@id="content"]/div/ul/li[4]/a')
        ...
        click_detail_page = driver.find_element(By.XPATH, '//*[@id="content"]/div/p[1]/a')
